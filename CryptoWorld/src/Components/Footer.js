        ...
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 lg:max-w-sm">
              ...
              CryptoWorld is an online money management system with the aim of 
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              ...
              <a
                href="mailto:sengaradarsh101@gmail.com"
                aria-label="Our email"
                title="Our email"
                className="text-white pl-2"
              >
                sengaradarsh101@gmail.com
              </a>
            </div>
            <div className="flex">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-gray-200">
              Follow us on our social media accounts to stay updated on the latest updates from CryptoWorld
            </p>
          </div>
        </div>
        <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
          <p className="text-sm text-gray-100">
          © Copyright 2021 CryptoWorld .Inc All Right Reserved 
          </p>
